...
/*SELECT 
    ...
    VEICULO.MARCA,
    VEICULO.MODELO,
	SUM(ITEM_SERVICO.QTDE) AS QUANTIDADE_SERVICO, 
...
/*SELECT 
    ...
    VEICULO.MARCA,
    VEICULO.MODELO,
	SUM(ITEM_PRODUTO.QTDE) AS QUANTIDADE_SERVICO, 
...
FROM 
    ...
    MECANICO.IDMECANICO = ORCAMENTO.IDVEICULO
...
FROM(
    ...
    FROM(
        SELECT
            ORCAMENTO.IDORCAMENTO,
            SUM(SERVICO.VALOR*ITEM_SERVICO.QTDE) AS VALOR_TOTAL
        FROM
            ORCAMENTO
...
SELECT
    ...
    YEAR(ORCAMENTO.DT_ORCAMENTO) AS ANO
FROM
    ORCAMENTO
    INNER JOIN ITEM_SERVICO ON 
    ORCAMENTO.IDORCAMENTO = ITEM_SERVICO.IDORCAMENTO
...
FROM(
    ...
    FROM(
        SELECT
            DATE_FORMAT(DT_ORCAMENTO, '%m/%Y') as ANOMES,
            SUM(SERVICO.VALOR*ITEM_SERVICO.QTDE) AS VALOR_TOTAL
        FROM
            ORCAMENTO
            INNER JOIN ITEM_SERVICO ON
